...
export default function Time() {
    ...
    return (
        <div className="whitespace-nowrap text-sm flex items-center gap-2 text-black dark:text-white border-[1px] border-[rgb(100,100,100)] shadow-lg dark:shadow-[0_0_10px_5px_rgb(255,255,255,0.1)] rounded py-1.5 px-3 w-fit h-[38px]">
            {
                (timeOfDay === "day") ? 
