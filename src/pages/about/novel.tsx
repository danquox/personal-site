            ...
            >
                {
                    NovelData.map(novel => {
                        return (
                            <motion.a variants={containerChildren} className="group shadow-lg dark:shadow-none rounded-xl relative text-white" href={novel.href} target="_blank"
                                whileHover={{
                                    scale: 1.035,
                                    transition: {
                                        duration: 0.2
                            ...
                            >
                                ...
                                <div className="opacity-0 group-hover:opacity-100 absolute flex items-center justify-center transition-opacity duration- bg-[rgb(0,0,0,0.75)] h-full w-full rounded-xl top-0 text-white">
                                    <p className="text-white text-center text-lg font-['Instrument_Sans'] font-extrabold">{novel.title}</p>
